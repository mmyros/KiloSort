function ops=ksort_config(fpath)
clear ops
% fpath='~/res/';
...
ops.fbinary             = fullfile(fpath, 'data.dat'); % will be created for 'openEphys'		
...
ops.Nfilt               = 4*64;  % number of clusters to use (2-4 times more than Nchan, should be a multiple of 32)     		
...
ops.NT                  = (128*1024+ ops.ntbuff)/2;% this is the batch size (try decreasing if out of memory)  --- mmyros ORIGINALLY 128*1024+ ops.ntbuff 
...
dd                  = load('~/mmy/KiloSort//configFiles/PCspikes2.mat'); % you might want to recompute this from your own data		
